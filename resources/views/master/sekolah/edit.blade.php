...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit — {{ $sekolah->nama_sekolah }}</li>
        </ol>
    </nav>
    ...
    <form id="sekolah-form"
          action="{{ route('api.master.sekolah.update', $sekolah) }}"
          method="POST"
          enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="_method" value="PUT">
        @include('master.sekolah._form', ['sekolah' => $sekolah])
    </form>
